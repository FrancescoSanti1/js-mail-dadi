...
btnVerifica.addEventListener("click",
    ...
    function() {
        const risposta = document.getElementById("esito");
        ...
        for (let i = 0; i < listaEmail.length; i++) {
            ...
            if (emailUtente === listaEmail[i]) {
                risposta.innerHTML = "Ottimo! Sei tra gli invitati, benvenuto!";
        ...
        if (emailAssente) {
            risposta.innerHTML = "Ci dispiace, non sei tra gli invitati.";
        }
